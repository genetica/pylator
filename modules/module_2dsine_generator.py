...
class Module(pyl.Model):
    ...
    def createModuleDictionary(self):
        ...
        self.moduleData["/inputs/width"] = self.simData["/user/signal/width"].value
        self.moduleData["/inputs/height"] = self.simData["/user/signal/height"].value
    ...
    def initialise(self, simData):
        ...
        self.image = np.zeros((simData["/input/height"], simData["/input/width"]))
